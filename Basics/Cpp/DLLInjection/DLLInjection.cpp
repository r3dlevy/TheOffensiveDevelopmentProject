...
int main(int argc, char *argv[]) {
	...
	LPCSTR DllPath = "C:\\msbox.dll"; // The Path to our DLL
	
	//HWND hwnd = FindWindowA(NULL, "Tutorial-x86_64"); // HWND (Windows window) by Window Name
	//DWORD procID = atoi(argv[1]); // A 32-bit unsigned integer, DWORDS are mostly used to store Hexadecimal Addresses
	DWORD procID = 8560;
